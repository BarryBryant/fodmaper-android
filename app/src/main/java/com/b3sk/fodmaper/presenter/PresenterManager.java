...
public class PresenterManager {
    ...
    private final Cache<Long, LifecyclePresenter<?>> presenters;
    ...
    public <P extends LifecyclePresenter<?>> P restorePresenter(Bundle savedInstanceState) {
    ...
    public void savePresenter(LifecyclePresenter<?> presenter, Bundle outState) {
